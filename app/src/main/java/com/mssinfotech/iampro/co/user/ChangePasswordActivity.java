...
import com.mssinfotech.iampro.co.OtpForgetActivity;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    private EditText etconform_pass;
   // private TextInputLayout tilotp,tilnpassword,tilcpassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etold_pass = findViewById(R.id.etold_pass);
        etnew_pass = findViewById(R.id.etnew_pass);
        etconform_pass = findViewById(R.id.etconform_pass);
