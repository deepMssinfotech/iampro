...
public class FriendRequestSwipeAdapter extends RecyclerView.Adapter<FriendRequestSwipeAdapter.MyViewHolder> {
    private Context context;
     public List<FriendRequestItem> notifyList;
    int user_block;
    String FrindStatus;
    ...
    public FriendRequestSwipeAdapter(Context context, List<FriendRequestItem> notifyList) {
