package com.mssinfotech.iampro.co.fcm;
...
public class FcmNotificationBuilder {
    ...
    private static final String SERVER_API_KEY = "AAAAyWH4ECw:APA91bF-QJRx4q3r6o9kKUqUvOCA52kS66vHutuUftmV6sKpej7rwMEaT3gW8Rvpj6523fsHVyLJCGxAbmjqqb6yhWjx7ukQ-d5lByIjTA_THL6Ogtvsfvv05cfEfJ40hhU1ZcEBLHJF";
    private static final String CONTENT_TYPE = "Content-Type";
    private static final String APPLICATION_JSON = "application/json";
    private static final String AUTHORIZATION = "Authorization";
    private static final String AUTH_KEY = "key=" + SERVER_API_KEY;
    private static final String FCM_URL = "https://fcm.googleapis.com/fcm/send";
    //private static final String FCM_URL="https://attendance-175514.firebaseio.com/fcm/send";
    // json related keys
