...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, final PickerOptionListener listener) {
        ...
        final PickerOptionListener listeners=listener;
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle(context.getString(R.string.lbl_set_profile_photo));

        // add a list
        String[] optionsarray = {context.getString(R.string.lbl_take_camera_picture), context.getString(R.string.lbl_choose_from_gallery)};
        ...
        /*builder.setItems(animals, (dialog, which) -> {
         ...
         builder.setItems(optionsarray, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch (which) {
                    case 0:
                        listeners.onTakeCameraSelected();
                        break;
                    case 1:
                        listeners.onChooseGallerySelected();
                        break;
                }
            }
        });
